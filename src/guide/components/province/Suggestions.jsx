...
function Suggestions({ provinceData }) {
    ...
    return (
        <div className="flex flex-col gap-5">
            <h1 className="font-main flex justify-center text-3xl font-bold text-brand-white/95 md:pb-4 md:text-4xl"
            style={{  textShadow: '0 0 6px rgba(0, 0, 0, 0.9)'}}>Lugares Turisticos</h1>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex flex-1 flex-col p-5">
                                <h3
                                    className="font-secondary-italic mt-2 text-2xl text-brand-blue/95"
