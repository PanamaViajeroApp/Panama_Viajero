const gualacaImageBase = '/images/destinations/chiriqui/boquete'

export const gualaca = {
  id: 'gualaca',
  provinceId: 'chiriqui',
  nombre: 'Gualaca',
  banner: {
  ...
  actividades: [
    ...
    },
    {
      nombre: 'Senderismo',
      descripcion:
        'Explora caminos naturales entre montañas, bosques y paisajes rurales.',
      icono: '',
    },
    {
      nombre: 'Fotografía',
  ...
  ubicacion: 'https://www.google.com/maps?q=Gualaca%20Chiriqui&output=embed',
}
