export const provincias = [
  {
    ...
    banner: {
      ...
      alt: 'Vista del destino de Chiriquí',
    },

    descripcionCorta:
      'Chiriquí combina montañas, playas, cafetales y pueblos de clima fresco en un solo destino. Es un destino ideal para quienes buscan naturaleza, aventura y experiencias auténticas en el occidente panameño.',
