export const provincias = [
  {
    ...
    actividades: [
      ...
      'Observación del río Chagres',
      'Visita a ruinas coloniales',
      'Senderismo cercano',
      ...
      'Turismo educativo',
      'Recorrido familiar',
      'Observación del lago Gatún',
      'Paseo turístico',
      'Avistamiento de naturaleza',
      'Visita guiada',
      'Fotografía de paisajes',
      'Paseos escénicos',
      'Visita al entorno canalero',
      'Conexión con San Lorenzo',
      'Turismo de aventura',
      ...
      'Paseos en lancha',
      'Kayak',
      'Visita a las fortificaciones históricas',
      'Recorrido por el centro histórico',
      'Visita a la Iglesia de San Felipe',
