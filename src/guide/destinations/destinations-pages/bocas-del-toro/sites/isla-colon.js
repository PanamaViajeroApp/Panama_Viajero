const islaColonImageBase = '/images/destinations/bocas-del-toro/sites/isla-colon'

export const islaColon = {
  id: 'isla-colon',
  provinceId: 'bocas-del-toro',
  nombre: 'Isla Colón',
  banner: {
    src: `${islaColonImageBase}/banner/bg-isla-colon.jpg`,
    alt: 'Banner de Isla Colón',
  },
  gallery: [
    `${islaColonImageBase}/banner/bg-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g1-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g2-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g3-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g4-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g5-Isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g6-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g7-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g8-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g9-isla-colon.jpg`,
    `${islaColonImageBase}/gallery/g10-isla-colon.jpg`,
  ],
  descripcion:
  ...
  ubicacion:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113991.90522804018!2d-82.3660619629151!3d9.385267116557012!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8fa61ebcf4248227%3A0xf11b460512ea6d42!2sCol%C3%B3n%20Island!5e1!3m2!1sen!2spa!4v1780589079170!5m2!1sen!2spa',
}
