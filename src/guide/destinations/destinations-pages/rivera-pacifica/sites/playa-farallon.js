...
export const playaFarallon = {
  ...
  banner: { src: base, alt: 'Banner de Playa Farallón' },
  descripcion:
  ...
  actividades: [
    ...
    },
    {
      nombre: 'Senderismo',
      descripcion:
        'Explora senderos cercanos y miradores naturales que ofrecen vistas panorámicas del Pacífico.',
      icono: '',
    },
    {
      nombre: 'Avistamiento de fauna',
      descripcion:
        'Observa aves marinas y otras especies que habitan en las zonas rocosas y costeras.',
      icono: '',
    },
    {
      nombre: 'Pícnic',
